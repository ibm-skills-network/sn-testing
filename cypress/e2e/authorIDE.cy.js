describe('empty spec', () => {
  ...
  it('can render instructions and move between pages', () => {
    ...
    cy.instructions().page(3).should('be.visible').contains('Author IDE is a tool for creating and managing your instructions.')
    ...
    cy.instructions().page(7).contains('Feel free to explore what other buttons do on your own.')
